        ...
        <table class="table" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right">{{ numberFormat(moneyFormat($item->master_price)) }}</td>
                    <td align="right">{{ $salesOrder->discount_sales }}%</td>
                    <td align="right">{{ numberFormat(moneyFormat($item->master_total_price * (100 - $salesOrder->discount_sales)/100)) }}</td>
                </tr>
                @endforeach
            ...
            <tfoot>
                <tr valign="top" style="border-top: 1px black solid">
                    @php
                        $total_with_discount = $salesOrder->items->sum('master_total_price') * (100 - $salesOrder->discount_sales)/100;
                    @endphp
